...
**Shipyard integration:** This skill is the foundation of `/shipyard:init`. When initializing a project, brainstorming drives the requirements gathering phase - exploring what needs to be built before any plan is written.
